...
public class RandomUtil {
    ...
    public static String createCoupons(int length, String head, String tail) {
        StringBuilder builder = new StringBuilder();
        builder.append(head).append(generateUpperString(length - head.length() - tail.length())).append(tail);
...
//        System.out.println(generateUpperString(14));
//        System.out.println(generateLowerString(14));

//        System.out.println(createCoupons(16,"NA"));
